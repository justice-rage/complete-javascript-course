...
//     console.log(dog >= 3 ? `Dog number ${i + 1} is an adult and is ${dog} years old.` : `Dog number ${i + 1} is a puppy and is ${dog} years old.`);
//   })
// };
...
// This time, they want to convert dog ages to human ages and calculate the average age of 
...
// .filter(mov => mov > 0)
// // Great for debugging method chains
// .map((mov, i, arr) => {
//   // console.log(arr);
//   return mov * euroToUsd;
// })
...
//   const average = adults.reduce((acc, age, i, arr) => acc + age, 0) / arr.length;
...
// const avg1 = calcAverageHumanAge(td1);
// const avg2 = calcAverageHumanAge(td2);
